...
<template>
    <div
        class="border-b-donut-600 dark:border-b-donut-400 border-b-2 bg-[color:var(--donut-bg)] dark:bg-[color:var(--donut-bg-dark)] text-[color:var(--donut-text)] dark:text-[color:var(--donut-text-dark)]">


        <div class="pt-5 items-center justify-center w-100 px-2 sm:px-6 lg:px-8  hidden sm:block">
        ...
        <Disclosure as="nav" class=" text-donut-800 dark:text-donut-200" v-slot="{ open }">
            <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 ">
                <div class="relative flex h-16 items-center justify-between">
                    ...
                    <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        ...
                        <div class="hidden sm:ml-6 sm:block">
                            <div class="flex space-x-4 pl-10">
                                <router-link v-for="item in router.options.routes" :key="item.name" :to="item.path"
                                    :class="[
                    ...
                    <div class="absolute inset-y-0 right-0 flex items-center sm:static sm:inset-auto sm:ml-6 sm:pr-0 pt-1">
                        <label for="Theme Change" class="block px-1 dark:text-donut-300">
                            <button @click="toggleTheme" id="themebutton" type="button"
                                class="button cursor-pointer" title="Switch to light or dark theme">
